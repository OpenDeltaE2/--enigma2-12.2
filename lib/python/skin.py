...
DEFAULT_SKIN = SystemInfo["HasFullHDSkinSupport"] and "delta-blackred-fhd/skin.xml" or "delta-black-fhd/skin.xml"  # SD hardware is no longer supported by the default skin.
